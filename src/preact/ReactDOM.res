...
module Client = {
  module Root = {
    ...
    @send external render: (t, Preact.element) => unit = "render"
...
module Ref = {
  type t = domRef
  type currentDomRef = Preact.ref<Js.nullable<Dom.element>>
...
external createDOMElementVariadic: (
  string,
  ~props: domProps=?,
  array<Preact.element>,
) => Preact.element = "createElement"

external someElement: Preact.element => option<Preact.element> = "%identity"
...
external stringToComponent: string => Preact.component<'a> = "%identity"
